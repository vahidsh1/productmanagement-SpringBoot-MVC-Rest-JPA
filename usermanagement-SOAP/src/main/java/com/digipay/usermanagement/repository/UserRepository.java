...
import java.util.Scanner;
    ...
    public class UserRepository extends BaseRepositoryImpl<User> {
        ...
        public User listAnEntity(User user) {
            List<User> entityList = (List<User>) entityManager.createQuery("SELECT a FROM User a where a.nationalID= :nid").setParameter("nid",user.getNationalID()).getResultList();
